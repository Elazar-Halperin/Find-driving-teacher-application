...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.Holder> {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        if (isSender) {
            ...
            ll_container.setBackgroundResource(R.drawable.message_background);
            // color text into white that match into purple.
            tv_message.setTextColor(holder.itemView.getContext().getColor(R.color.white));
            ...
            ll_container.setBackgroundResource(R.drawable.message_background2);
